...
_PDF_LABELS: dict[str, dict[str, str]] = {
    "es": {
        ...
        "formula": "Fórmula",
        "result": "Resultado",
        "charts": "Graficos — Analisis de resultados",
        "chart_fat": "Porcentaje de grasa corporal",
        "chart_imc": "Indice de Masa Corporal (IMC)",
        "chart_ffmi": "FFMI normalizado (1.80 m)",
        "chart_macros": "Distribucion de macronutrientes (kcal)",
    },
    "en": {
    ...
    "fr": {
        ...
        "formula": "Formule",
        "result": "R\u00e9sultat",
        "charts": "Graphiques — Analyse des resultats",
        "chart_fat": "Pourcentage de graisse corporelle",
        "chart_imc": "Indice de Masse Corporelle (IMC)",
        "chart_ffmi": "FFMI normalise (1.80 m)",
        "chart_macros": "Repartition des macronutriments (kcal)",
    },
    "de": {
        ...
        "chart_fat": "Korperfettanteil",
        "chart_imc": "Body-Mass-Index (BMI)",
        "chart_ffmi": "Normalisierter FFMI (1.80 m)",
        "chart_macros": "Makronahrstoffverteilung (kcal)",
    },
    "pt": {
        ...
        "formula": "F\u00f3rmula",
        "result": "Resultado",
        "charts": "Graficos — Analise de resultados",
        "chart_fat": "Percentual de gordura corporal",
        "chart_imc": "Indice de Massa Corporal (IMC)",
        "chart_ffmi": "FFMI normalizado (1.80 m)",
        "chart_macros": "Distribuicao de macronutrientes (kcal)",
    },
    "nl": {
    ...
    "pl": {
        ...
        "body_comp": "Sk\u0142ad cia\u0142a (US Navy)",
        "body_fat": "T\u0142uszcz cia\u0142a",
        "lean_mass": "Masa mi\u0119\u015bniowa",
        "imc_ffmi": "BMI i FFMI",
        "imc": "BMI",
        "ffmi": "FFMI",
